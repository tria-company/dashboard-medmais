...
/** Linha do card de processos trabalhistas */
export interface ProcessoTrabalhistaRow {
  quemProcessou: string;
  ondeFoi: string;
  tipoProcesso: string;
  posto: string;
  cliente: string;
...
export const processosTrabalhistasData: ProcessoTrabalhistaRow[] = [
  { quemProcessou: "Ana R. Silva", ondeFoi: "TRT 2ª Região - São Paulo", tipoProcesso: "Rescisão indireta", posto: "Portaria", cliente: "JBS", valor: "R$ 18.500,00" },
  { quemProcessou: "Carlos M. Oliveira", ondeFoi: "TRT 3ª Região - Belo Horizonte", tipoProcesso: "Horas extras", posto: "Vigilante", cliente: "Vale", valor: "R$ 12.200,00" },
  { quemProcessou: "Maria F. Costa", ondeFoi: "TRT 4ª Região - Porto Alegre", tipoProcesso: "Verbas rescisórias", posto: "Recepção", cliente: "Bradesco", valor: "R$ 9.800,00" },
  { quemProcessou: "Roberto P. Santos", ondeFoi: "TRT 15ª Região - Campinas", tipoProcesso: "Acidente de trabalho", posto: "Manutenção", cliente: "Ambev", valor: "R$ 45.000,00" },
  { quemProcessou: "Fernanda L. Lima", ondeFoi: "TRT 2ª Região - São Paulo", tipoProcesso: "Discriminação", posto: "Controle de Acesso", cliente: "Mag. Luiza", valor: "R$ 22.000,00" },
  { quemProcessou: "José A. Ribeiro", ondeFoi: "TRT 1ª Região - Rio de Janeiro", tipoProcesso: "Rescisão sem justa causa", posto: "Guarita", cliente: "Petrobras", valor: "R$ 15.300,00" },
];
