...
/** Item do ranking de NRs em atraso (por empresa/cliente) */
export interface NRsEmAtrasoRankingItem {
  empresa: string;
  quantidade: number;
}
...
/** Ranking de NRs em atraso por empresa (para o card com toggle). */
export const nrsEmAtrasoRanking: NRsEmAtrasoRankingItem[] = [
  { empresa: "Petrobras", quantidade: 513 },
  { empresa: "Vale", quantidade: 500 },
  { empresa: "JBS", quantidade: 300 },
  { empresa: "Bradesco", quantidade: 200 },
  { empresa: "Ambev", quantidade: 100 },
  { empresa: "Mag. Luiza", quantidade: 100 },
  { empresa: "Itaú", quantidade: 100 },
];
